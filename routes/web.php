...
Route::get('/user/{user}', [ProfileController::class, 'show'])->name('user.profile')->middleware(['auth', 'check.ban']);

// Public Ban History (All users can view)
Route::get('/user/{user}/ban-history', [BanController::class, 'publicHistory'])->name('user.ban.history')->middleware(['auth', 'check.ban']);
...
Route::middleware(['auth', 'check.ban'])->group(function () {
    Route::get('/user/{user}/ban', [BanController::class, 'create'])->name('admin.ban.create');
    Route::post('/user/{user}/ban', [BanController::class, 'store'])->name('admin.ban.store');
    Route::post('/user/{user}/unban', [BanController::class, 'unban'])->name('admin.ban.unban');
    Route::get('/user/{user}/admin/ban-history', [BanController::class, 'history'])->name('admin.ban.history');
});
